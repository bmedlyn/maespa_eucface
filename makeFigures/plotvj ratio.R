pdf("vj ratio.pdf",width = 8,height = 6)
...
lai.df<- data.frame(lai = c(mean(data.both.sap.ctrl$LAI[data.both.sap.ctrl$Ring == "R1"]),
                            mean(data.both.sap.ctrl$LAI[data.both.sap.ctrl$Ring == "R2"]),
                            mean(data.both.sap.ctrl$LAI[data.both.sap.ctrl$Ring == "R3"]),
                            mean(data.both.sap.ctrl$LAI[data.both.sap.ctrl$Ring == "R4"]),
                            mean(data.both.sap.ctrl$LAI[data.both.sap.ctrl$Ring == "R5"]),
                            mean(data.both.sap.ctrl$LAI[data.both.sap.ctrl$Ring == "R6"])))

# annual sum gpp 
gpp.df.e <- data.frame(gpp=c(sum(data.both.sap.ctrl$GPP[data.both.sap.ctrl$Ring == "R1"])/years,
...
gpp.df.a <- data.frame(gpp=c(sum(data.both.sap.m.150$GPP[data.both.sap.m.150$Ring == "R1"])/years,
                             ...
                             sum(data.both.sap.ctrl$GPP[data.both.sap.ctrl$Ring == "R2"])/years,
                             sum(data.both.sap.ctrl$GPP[data.both.sap.ctrl$Ring == "R3"])/years,
                             sum(data.both.sap.ctrl$GPP[data.both.sap.ctrl$Ring == "R6"])/years))
...
apar.df <-data.frame(apar=c(sum(data.both.sap.m.150$APAR[data.both.sap.m.150$Ring == "R1"])/years,
                            ...
                            sum(data.both.sap.ctrl$APAR[data.both.sap.ctrl$Ring == "R2"])/years,
                            sum(data.both.sap.ctrl$APAR[data.both.sap.ctrl$Ring == "R3"])/years,
                            sum(data.both.sap.ctrl$APAR[data.both.sap.ctrl$Ring == "R6"])/years))
