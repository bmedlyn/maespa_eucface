...
plot.vc.fit(euc.vc.ls[[1]]$Vcmax,euc.vc.ls[[1]]$ndays,col.in = 'blue')
plot.vc.fit(euc.vc.ls[[2]]$Vcmax,euc.vc.ls[[2]]$ndays,col.in = 'red')
...
plot.vc.fit(euc.sum.df$Jmax,euc.sum.df$ndays,col.in = 'grey')
# plot.vc.fit(euc.vc.ls[[2]]$Jmax,col.in = 'red')
legend('topright',legend = c('A','E'),pch=16,col=c('blue','red'),bty='n')


# 
# mean(euc.vc.ls[[1]]$Vcmax) / mean(euc.vc.ls[[2]]$Vcmax)
# quantile(euc.vc.ls[[1]]$Vcmax,probs = 0.8)
# quantile(euc.vc.ls[[2]]$Vcmax,probs = 0.8)
# euc.vc.df <- do.call(rbind,euc.vc.ls)
euc.vj.df <- data.frame(Vc.a = pred.vc.func(euc.vc.ls[[1]]$Vcmax,euc.vc.ls[[1]]$ndays),
                        Vc.e = pred.vc.func(euc.vc.ls[[2]]$Vcmax,euc.vc.ls[[2]]$ndays),
                        J.a = pred.vc.func(euc.sum.df$Jmax,euc.sum.df$ndays),
                        J.e = pred.vc.func(euc.sum.df$Jmax,euc.sum.df$ndays))
...
for (i in 1:length(euc.4y.ls)){
  ...
  euc.pred.ls[[i]] <- data.frame(v.a = pred.vc.func(euc.vc.ls[[1]]$Vcmax,euc.vc.ls[[1]]$ndays,
                                 ...
                                 v.e = pred.vc.func(euc.vc.ls[[2]]$Vcmax,euc.vc.ls[[2]]$ndays,
                                                    euc.4y.ls[[i]]$ndays)$y,
                                 j.a = pred.vc.func(euc.sum.df$Jmax,euc.sum.df$ndays,euc.4y.ls[[i]]$ndays)$y,
                                 j.e = pred.vc.func(euc.sum.df$Jmax,euc.sum.df$ndays,euc.4y.ls[[i]]$ndays)$y,
                                 date = euc.4y.ls[[i]]$date)
  
}

# quantile(euc.sum.df$Jmax,probs = 0.8)
# quantile(euc.sum.df$Jmax,probs = 0.2)
# 
# quantile(euc.vc.ls[[1]]$Vcmax,probs = 0.8)
# quantile(euc.vc.ls[[1]]$Vcmax,probs = 0.2)
# 
# quantile(euc.vc.ls[[2]]$Vcmax,probs = 0.8)
